...
/**
 * AppointmentStatusSearches represents the model behind the search form of `dashboard\models\AppointmentStatus`.
 */
class AppointmentStatusSearches extends AppointmentStatus
{
    /**
     * {@inheritdoc}
     */
